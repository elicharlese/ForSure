      ...
      <div className="space-y-8">
        ...
        <AnimateOnScroll type="fade">
          <div className="prose dark:prose-invert max-w-none">
            <p>
              This Privacy Policy describes how ForSure ("we", "us", or "our") collects, uses, and discloses your
              information when you use our website, products, and services (collectively, the "Services").
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                the pages you visit, the time you spend on each page, and the actions you take.
              </li>
              <li>
                <strong>Device Information:</strong> We collect information about the device you use to access our
                Services, including the hardware model, operating system, and browser type.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                ...
                comply with a legal obligation, protect our rights or the rights of others, or investigate fraud or
                security issues.
              </li>
              <li>
            ...
            <p>
              ...
              under 13, we will take steps to delete that information as quickly as possible.
            </p>

            <h2>Changes to This Privacy Policy</h2>
            <p>
              We may update this Privacy Policy from time to time. If we make material changes, we will notify you by
              email or by posting a notice on our website prior to the change becoming effective. We encourage you to
