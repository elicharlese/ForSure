...
export default function SyntaxPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-lg text-muted-foreground">Learn the fundamental syntax of the ForSure language.</p>
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">File Structure</h2>
        <p>
          ForSure files use a hierarchical structure to represent directories and files. The basic syntax follows these
          rules:
        </p>
  ...
  - directory_name:
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">Root Declaration</h2>
        <p>Every ForSure file must start with a root declaration, which represents the top-level directory:</p>
        <DocsCodeBlock
          code={`root:
  # Contents go here`}
        />
  ...
  # Contents go here`}
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">Directories and Files</h2>
        <p>Directories and files are defined using a hyphen (-) followed by the name:</p>
        <DocsCodeBlock
          code={`root:
  - src:              # This is a directory
      ...
      - components:   # This is a nested directory
        ...
        />
        <p>
          The presence of a colon (:) after the name indicates that it's a directory. Without a colon, it's treated as a
          file.
        </p>
      </div>
  ...
  - src:
      ...
      - index.js  # Inline comment`}
        />
        <p>Comments are useful for documenting the purpose of files and directories or providing additional context.</p>
        <Link href="/docs/syntax/comments" className="text-primary hover:underline">
  ...
  - src:
      ...
      - config.json { env: "production" }`}
        />
        <p>Attributes can be strings, booleans, numbers, or even nested objects.</p>
        <Link href="/docs/syntax/attributes" className="text-primary hover:underline">
          Learn more about attributes →
        </Link>
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">Import Directives</h2>
        <p>ForSure allows you to import other ForSure files using the @import directive:</p>
        <DocsCodeBlock
          code={`root:
  - src:
      ...
      - index.js`}
        />
        <p>This is useful for reusing common file structures across projects.</p>
        <Link href="/docs/syntax/import-directives" className="text-primary hover:underline">
          Learn more about import directives →
        </Link>
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">Complete Example</h2>
  ...
  - README.md`}
      ...
      <div className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <Link href="/docs/syntax/file-structure" className="text-primary hover:underline">
