  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-lg text-muted-foreground">How to install and set up ForSure on your system.</p>
      </div>

      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">Prerequisites</h2>
        <p>Before installing ForSure, ensure you have the following prerequisites:</p>
...
cd ForSure`}
        ...
        <p>The repository contains sample .forsure files that you can review to understand the syntax and structure:</p>
        <DocsCodeBlock
          code={`ls -la
# Review the sample files and documentation`}
        ...
        <h3 className="text-xl font-medium">3. Optional: Set up for Development</h3>
        <p>
...
yarn install`}
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold tracking-tight">Verifying Installation</h2>
        <p>
...
./forsure generate test.forsure --output ./test-output`}
          language="bash"
        />
        <p>If the installation is successful, this should create a test.txt file in the test-output directory.</p>
      </div>
