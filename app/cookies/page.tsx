    ...
    <div className="container py-12 max-w-4xl">
      <div className="space-y-8">
        <div>
          ...
          <h1 className="text-4xl font-bold tracking-tight mb-4">Cookies Policy</h1>
        ...
        <AnimateOnScroll type="fade">
          <div className="prose dark:prose-invert max-w-none">
            <p>
              This Cookies Policy explains how ForSure ("we", "us", or "our") uses cookies and similar technologies to
            ...
            <p>
              Cookies set by the website owner (in this case, ForSure) are called "first-party cookies". Cookies set by
            ...
            <p>
              ...
              experience on our Services. Third parties serve cookies through our Services for advertising, analytics,
              and other purposes.
            </p>

            <h2>Types of cookies we use</h2>
            <p>
              The specific types of first and third-party cookies served through our Services and the purposes they
              perform are described below:
            </p>

            <h3>Essential Cookies</h3>
            <p>
              These cookies are strictly necessary to provide you with services available through our Services and to
              use some of its features, such as access to secure areas. Because these cookies are strictly necessary to
              deliver the Services, you cannot refuse them without impacting how our Services function.
            </p>

            <h3>Performance and Functionality Cookies</h3>
            <p>
              These cookies are used to enhance the performance and functionality of our Services but are non-essential
            ...
            <p>
              ...
              privacy@forsure-lang.com or contact us at:
            </p>
            <p>
              ForSure
              <br />
