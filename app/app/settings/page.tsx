...
import { ArrowLeft, Settings, Palette, Code, Globe, Bell, Shield, Keyboard, Database } from "lucide-react"
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Customize your ForSure experience</p>
          </div>
        </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select value={editorSettings.theme} onValueChange={(value) => handleEditorChange("theme", value)}>
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) => handleEditorChange("fontSize", value[0])}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleEditorChange("tabSize", Number.parseInt(value))}
                  >
                ...
                <div className="space-y-2">
                  <Label htmlFor="print-width">Print Width ({formatterSettings.printWidth} chars)</Label>
                  <Slider
                    id="print-width"
                    min={40}
                    max={120}
                    ...
                    onValueChange={(value) => setFormatterSettings((prev) => ({ ...prev, printWidth: value[0] }))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleEditorChange("wordWrap", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleEditorChange("lineNumbers", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleEditorChange("minimap", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleEditorChange("formatOnSave", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Automatically indent code</p>
                  </div>
                  <Switch
                    checked={editorSettings.autoIndent}
                    onCheckedChange={(checked) => handleEditorChange("autoIndent", checked)}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="font-medium">Bracket Pair Colorization</Label>
                    <p className="text-sm text-muted-foreground">Colorize matching brackets</p>
                  </div>
                  <Switch
                    checked={editorSettings.bracketPairs}
                    onCheckedChange={(checked) => handleEditorChange("bracketPairs", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Enable code snippets</p>
                  </div>
                  <Switch
                    checked={editorSettings.snippets}
                    onCheckedChange={(checked) => handleEditorChange("snippets", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Automatically close brackets</p>
                  </div>
                  <Switch
                    checked={editorSettings.autoClosingBrackets}
                    onCheckedChange={(checked) => handleEditorChange("autoClosingBrackets", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Automatically close quotes</p>
                  </div>
                  <Switch
                    checked={editorSettings.autoClosingQuotes}
                    onCheckedChange={(checked) => handleEditorChange("autoClosingQuotes", checked)}
                  />
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="appearance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Customize the look and feel of ForSure</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Show status bar at the bottom</p>
                  </div>
                  <Switch
                    checked={appearanceSettings.showStatusBar}
                    onCheckedChange={(checked) =>
                      setAppearanceSettings((prev) => ({ ...prev, showStatusBar: checked }))
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) => setAppearanceSettings((prev) => ({ ...prev, sidebarPosition: value }))}
        ...
        <TabsContent value="formatter">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure code formatting preferences</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormatterSettings((prev) => ({ ...prev, defaultFormatter: value }))}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Add semicolons at the end of statements</p>
                  </div>
                  <Switch
                    checked={formatterSettings.semiColons}
                    onCheckedChange={(checked) => setFormatterSettings((prev) => ({ ...prev, semiColons: checked }))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Use single quotes instead of double quotes</p>
                  </div>
                  <Switch
                    checked={formatterSettings.singleQuote}
                    onCheckedChange={(checked) => setFormatterSettings((prev) => ({ ...prev, singleQuote: checked }))}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormatterSettings((prev) => ({ ...prev, trailingComma: value }))}
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormatterSettings((prev) => ({ ...prev, arrowParens: value }))}
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormatterSettings((prev) => ({ ...prev, endOfLine: value }))}
                >
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="format-completed"
                      checked={notificationSettings.formatCompletedNotifications}
                      onCheckedChange={(checked) =>
                    ...
                    />
                    <Label htmlFor="format-completed">Format completed notifications</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="validation-error"
                      checked={notificationSettings.validationErrorNotifications}
                      onCheckedChange={(checked) =>
                        setNotificationSettings((prev) => ({
                          ...prev,
                    ...
                    />
                    <Label htmlFor="validation-error">Validation error notifications</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="team-invite"
                    ...
                    />
                    <Label htmlFor="team-invite">Team invite notifications</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                    ...
                    />
                    <Label htmlFor="update-notifications">Product update notifications</Label>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="notification-email" type="email" placeholder="Enter email address for notifications" />
              </div>
            </CardContent>
            <CardFooter className="flex justify-between border-t pt-6">
              <Button variant="outline" onClick={handleResetSettings}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setKeyboardSettings((prev) => ({ ...prev, formatShortcut: e.target.value }))}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setKeyboardSettings((prev) => ({ ...prev, validateShortcut: e.target.value }))}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setKeyboardSettings((prev) => ({ ...prev, saveShortcut: e.target.value }))}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setKeyboardSettings((prev) => ({ ...prev, newFileShortcut: e.target.value }))}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setKeyboardSettings((prev) => ({ ...prev, findShortcut: e.target.value }))}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setKeyboardSettings((prev) => ({ ...prev, replaceShortcut: e.target.value }))}
                  />
                </div>
              </div>
        ...
        <TabsContent value="integrations">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Connect ForSure with external services</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <Button variant={integrationSettings.githubConnected ? "outline" : "default"}>
                    {integrationSettings.githubConnected ? "Disconnect" : "Connect"}
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Deploy your projects directly to Vercel</p>
                    </div>
                  </div>
                  <Button variant={integrationSettings.vercelConnected ? "outline" : "default"}>
                    {integrationSettings.vercelConnected ? "Disconnect" : "Connect"}
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get notifications in your Slack workspace</p>
                    </div>
                  </div>
                  <Button variant={integrationSettings.slackConnected ? "outline" : "default"}>
                    {integrationSettings.slackConnected ? "Disconnect" : "Connect"}
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Integrate with VS Code editor</p>
                    </div>
                  </div>
                  <Button variant={integrationSettings.vscodeConnected ? "outline" : "default"}>
                    {integrationSettings.vscodeConnected ? "Disconnect" : "Connect"}
                  </Button>
                </div>
              </div>
        ...
        <TabsContent value="storage">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure how your projects and files are stored</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Store projects in browser local storage</p>
                  </div>
                  <Switch
                    checked={storageSettings.localStorageEnabled}
                    onCheckedChange={(checked) =>
                      setStorageSettings((prev) => ({ ...prev, localStorageEnabled: checked }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Sync projects to cloud storage</p>
                  </div>
                  <Switch
                    checked={storageSettings.cloudSyncEnabled}
                    onCheckedChange={(checked) =>
                      setStorageSettings((prev) => ({ ...prev, cloudSyncEnabled: checked }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setStorageSettings((prev) => ({ ...prev, compressionEnabled: checked }))
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="max-backup-size">Maximum Backup Size ({storageSettings.maxBackupSize} MB)</Label>
                <Slider
                  id="max-backup-size"
                  min={10}
                  max={500}
                  ...
                  onValueChange={(value) => setStorageSettings((prev) => ({ ...prev, maxBackupSize: value[0] }))}
                  disabled={!storageSettings.autoBackup}
                />
              </div>
              ...
              <div className="border rounded-md p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-muted-foreground">245 MB of 1 GB used</span>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="telemetry">Allow telemetry data collection</Label>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground mt-1">Used for programmatic access to the ForSure API</p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">iPhone • Last active: 2 days ago</p>
                    </div>
