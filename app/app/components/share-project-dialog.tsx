...
export function ShareProjectDialog({ project, onShare, onUnshare, trigger }: ShareProjectDialogProps) {
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Anyone with this link can view your project{usePassword ? " (password protected)" : ""}.
              </p>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" onClick={() => setShareUrl(null)}>
                  Edit Settings
                </Button>
              </div>
              <div className="rounded-md border p-3 text-sm space-y-2">
                ...
                {useExpiration && (
                  <div className="flex justify-between">
                    <span>Expires</span>
                    <span>
                      {expirationType === "time" ? `After ${expirationTime} days` : `After ${maxViews} views`}
                    </span>
                  </div>
                )}
                <div className="flex justify-between">
          ...
          <div className="space-y-4 py-2">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Let viewers copy your project structure</p>
              </div>
              <Switch id="copy" checked={allowCopy} onCheckedChange={setAllowCopy} />
            </div>

            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label htmlFor="comments">Allow comments</Label>
                <p className="text-xs text-muted-foreground">Let viewers leave comments on your project</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Limit how long the share link is valid</p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setExpirationType(value as "time" | "views")}
                    >
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Require a password to view your project</p>
              </div>
              <Switch id="password" checked={usePassword} onCheckedChange={setUsePassword} />
            </div>
