...
export function FileEditor({ fileName, content: initialContent, onSave, onClose, className }: FileEditorProps) {
    ...
    switch (extension) {
      ...
      case "json":
        try {
          ...
          return <div className="p-4 text-red-500">Invalid JSON: {(e as Error).message}</div>
        }
      default:
        return (
          <pre className="p-4 overflow-auto bg-muted rounded-md">
