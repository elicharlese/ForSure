...
const predefinedTemplates: ProjectTemplate[] = [
  // Next.js Templates
  {
    ...
    name: 'Next.js Basic',
    description:
      'A simple Next.js project with App Router and basic components',
    framework: 'nextjs',
    type: 'web',
    complexity: 'simple',
  ...
  },
  {
    ...
    description:
      'A comprehensive Next.js project with API routes, authentication, and database integration',
    framework: 'nextjs',
    type: 'web',
    complexity: 'advanced',
    tags: [
  ...
  },
  {
    ...
    description:
      'A React project with Redux, TypeScript, and organized feature folders',
    framework: 'react',
    type: 'web',
    complexity: 'advanced',
  ...
  },
  {
    ...
    description:
      'A comprehensive Express.js API with TypeScript, MongoDB, authentication, and testing',
    framework: 'express',
    type: 'api',
    complexity: 'advanced',
  ...
  // Mobile App Templates
  {
    ...
    description:
      'A simple React Native project with navigation and basic screens',
