...
export function autoFormatForSure(
  content: string,
...
function fixBraces(content: string, changes: AutoFormatChange[]): string {
  ...
  const bracePatterns = [
    ...
    },
    {
      pattern: /(\w)\s*\[\s*/g,
      replacement: '$1[',
      description: 'Fixed opening bracket spacing',
    },
    {
      pattern: /\s*\]\s*/g,
      replacement: ']',
      description: 'Fixed closing bracket spacing',
    },
  ]
  ...
  const spacingPatterns = [
    {
      pattern: /\s*,\s*/g,
      replacement: ', ',
      description: 'Fixed comma spacing',
    },
    {
      pattern: /\s*:\s*/g,
      replacement: ': ',
      description: 'Fixed colon spacing',
    },
    {
      pattern: /\s*;\s*/g,
      replacement: '; ',
      description: 'Fixed semicolon spacing',
    },
    {
      pattern: /\s*=\s*/g,
      replacement: ' = ',
      description: 'Fixed assignment spacing',
    },
    {
      pattern: /\s*\+\s*/g,
      replacement: ' + ',
      description: 'Fixed operator spacing',
    },
    {
      pattern: /\s*-\s*/g,
      replacement: ' - ',
  ...
  const keywordPatterns = [
    {
      ...
      description: 'Normalized component keyword',
    },
    {
      pattern: /\bpage\b/gi,
      replacement: 'page',
      description: 'Normalized page keyword',
    },
    {
      pattern: /\blayout\b/gi,
      replacement: 'layout',
      description: 'Normalized layout keyword',
    },
    {
      pattern: /\bstyle\b/gi,
      replacement: 'style',
      description: 'Normalized style keyword',
    },
    {
      pattern: /\bscript\b/gi,
      replacement: 'script',
      description: 'Normalized script keyword',
    },
    {
      pattern: /\bimport\b/gi,
      replacement: 'import',
      description: 'Normalized import keyword',
    },
    {
      pattern: /\bexport\b/gi,
      replacement: 'export',
      description: 'Normalized export keyword',
    },
  ]
...
function sortImports(content: string, changes: AutoFormatChange[]): string {
  ...
  if (imports.length > 1) {
    ...
    const hasChanges = imports.some(
      (line, index) =>
        line.trim().startsWith('import ') && sortedImports[index] !== line
    )
...
export function generateAutoFormatReport(
  results: Array<{ name: string; result: AutoFormatResult }>
): string {
