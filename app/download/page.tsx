  ...
  return (
    <div className="container py-12 max-w-4xl">
      <div className="space-y-8">
        <div>
          <h1 className="text-4xl font-bold tracking-tight mb-2">Download ForSure CLI</h1>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <CodeExample code="npm install -g forsure-cli" language="bash" />
                </div>
                <div>
                  <p className="mb-2 text-white/90">Using yarn:</p>
                  <CodeExample code="yarn global add forsure-cli" language="bash" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="mb-4 text-white/90">Download the binary for your platform:</p>
                <div className="space-y-3">
                  <Button asChild className="w-full justify-start" size="lg">
                    <a href="#" className="flex items-center">
                      <Download className="mr-2 h-5 w-5" /> macOS (Intel/Apple Silicon)
                    </a>
                  </Button>
                  <Button asChild className="w-full justify-start" size="lg">
                    <a href="#" className="flex items-center">
        ...
        <AnimateOnScroll type="slideUp">
          <section className="border rounded-lg p-6">
            ...
            <p className="mb-4">After installation, verify that the ForSure CLI is working correctly by running:</p>
            <CodeExample code="forsure --version" language="bash" />
            <p className="mt-4">You should see the version number of the ForSure CLI that you installed.</p>
          </section>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll type="slideUp" delay={0.1}>
          <section className="border rounded-lg p-6">
            ...
            <p className="mb-4">Create your first ForSure file and generate a project structure:</p>
            <div className="space-y-4">
              <div>
...
root:
  ...
  - Type: Directory
    ...
    Source code directory.
              ...
              <div>
                <p className="mb-2 font-medium">2. Generate the project structure:</p>
          ...
          <section className="border rounded-lg p-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="border rounded-md p-4">
                ...
                <p className="text-sm text-muted-foreground">Approximately 50MB of free disk space is required.</p>
              </div>
            </div>
          </section>
        </AnimateOnScroll>
        ...
        <section className="mt-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link href="/docs" className="block p-4 border rounded-lg hover:bg-muted transition-colors">
              <div className="font-semibold">Read the Documentation</div>
              <div className="text-sm text-muted-foreground">Learn how to use ForSure effectively</div>
            </Link>
            <Link href="/cli" className="block p-4 border rounded-lg hover:bg-muted transition-colors">
              <div className="font-semibold">Explore CLI Commands</div>
              <div className="text-sm text-muted-foreground">Discover all available CLI commands and options</div>
            </Link>
          </div>
        </section>
      </div>
